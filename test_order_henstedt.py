"""Test Order for Henstedt-Ulzburg Location"""
import asyncio
import requests
import json
...
async def create_test_order():
    """Create a test order for Henstedt-Ulzburg"""
    # Connect to MongoDB
    ...
    print("=" * 70)
    print("🧪 TESTBESTELLUNG FÜR HENSTEDT-ULZBURG")
    print("=" * 70)
    ...
    order_data = {
        ...
        "customer": {
            "name": "Test Kunde Henstedt",
            "phone": "017087654321",
            "email": "test@henstedt.de",
            "address": "Hamburger Straße 115",
            "postal_code": "24558",
