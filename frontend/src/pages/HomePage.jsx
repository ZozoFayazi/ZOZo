...
import { MapPin, Clock, Phone, ArrowRight, Star, ChevronLeft, ChevronRight, Users, Check } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group relative overflow-hidden rounded-xl bg-card border border-border card-hover cursor-pointer" onClick={() => navigate('/menu')}>
              <div className="aspect-[4/3] overflow-hidden">
                <img loading="lazy"
                  src="https://customer-assets.emergentagent.com/job_zozo-burger-1/artifacts/aeqq2xex_ChatGPT%20Image%208.%20Jan.%202026%2C%2019_13_00.png"
                  alt="Burger"
            ...
            <div className="group relative overflow-hidden rounded-xl bg-card border border-border card-hover cursor-pointer" onClick={() => navigate('/menu')}>
              <div className="aspect-[4/3] overflow-hidden">
                <img loading="lazy"
                  src="https://customer-assets.emergentagent.com/job_zozo-burger-1/artifacts/gulr5auj_ChatGPT%20Image%208.%20Jan.%202026%2C%2019_13_03.png"
                  alt="Pizza"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                />
              </div>
