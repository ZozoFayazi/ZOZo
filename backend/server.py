...
@api_router.post("/admin/menu-items/{item_id}/toggle")
...
async def validate_discount_code(validation: DiscountCodeValidate):
    ...
    # Check valid dates (handle both naive and timezone-aware datetimes)
    now = datetime.utcnow()  # Use naive datetime for MongoDB compatibility
