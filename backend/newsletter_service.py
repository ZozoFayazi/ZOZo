...
class NewsletterService:
    ...
    async def send_campaign(self, campaign_id: str) -> Dict:
        ...
        NOTE: This is a placeholder - actual email sending happens via email_service
        ...
        try:
            ...
            # Actual email sending would happen here via email_service
            ...
            logger.info(f"Campaign sent: {campaign.get('title')} to {sent_count} subscribers")
            
            return {
                "success": True,
                "message": f"Kampagne an {sent_count} Abonnenten gesendet",
