...
```bash
CORS_ORIGINS="*"
APP_URL="https://paypal-pos-fix.preview.emergentagent.com"
```
...
```bash
REACT_APP_BACKEND_URL=https://paypal-pos-fix.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
4. Test backend: `curl https://paypal-pos-fix.preview.emergentagent.com/api/`
