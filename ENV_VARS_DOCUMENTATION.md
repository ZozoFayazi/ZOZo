...
```bash
CORS_ORIGINS="*"
APP_URL="https://zozo-burger-1.preview.emergentagent.com"
```
...
```bash
REACT_APP_BACKEND_URL=https://zozo-burger-1.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
4. Test backend: `curl https://zozo-burger-1.preview.emergentagent.com/api/`
